    ...
    <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 space-y-3">
            <Link href="/" className="flex items-center gap-2 group">
              <span className="text-xl font-black text-white tracking-tight bg-gradient-to-r from-purple-400 via-indigo-300 to-blue-400 bg-clip-text text-transparent">
                MySpace
              </span>
            </Link>
        ...
        <div className="pt-8 border-t border-slate-800 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-500">
          <p>© 2026 Avero. All rights reserved.</p>
          <p className="font-handwriting text-base text-blue-300">Show who you are, not just what you do ✨</p>
        </div>
