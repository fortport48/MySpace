...
import { User, Mail, Lock, ArrowRight, Github, AlertCircle, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="w-full max-w-md space-y-8 bg-white/80 backdrop-blur-xl p-8 rounded-3xl border border-white/90 shadow-2xl shadow-blue-500/10">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-sky-400 text-white font-bold text-2xl shadow-md shadow-blue-500/30 mb-2">
            M
          </div>
          <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight">
            Create your Avero profile
          </h2>
          <p className="text-sm text-slate-500 font-medium">
            Express who you are outside of work in minutes
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-4 py-3 bg-slate-50 focus:bg-white text-sm text-slate-800 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all"
                placeholder="taylor"
              />
            </div>
            <p className="text-[11px] text-slate-400">Your public profile handle: avero.app/u/{username || 'username'}</p>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3.5 px-4 bg-blue-600 hover:bg-blue-700 disabled:opacity-70 text-white font-bold text-sm rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-xl transition-all flex items-center justify-center gap-2 mt-2"
          >
            {isLoading ? (
              <>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white px-3 text-slate-400 font-semibold">Or signup with</span>
          </div>
        </div>
